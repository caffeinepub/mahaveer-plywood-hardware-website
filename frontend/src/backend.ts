...
import type { BusinessSettings as _BusinessSettings, Category as _Category, Product as _Product, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: Category, arg2: string, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async editProduct(arg0: string, arg1: string, arg2: Category, arg3: string, arg4: string, arg5: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.editProduct(arg0, arg1, to_candid_Category_n8(this._uploadFile, this._downloadFile, arg2), arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async filterProductsByCategory(arg0: Category): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.filterProductsByCategory(to_candid_Category_n8(this._uploadFile, this._downloadFile, arg0));
    ...
    async updateBusinessSettings(arg0: BusinessSettings): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_opt_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_BusinessSettings]): BusinessSettings | null {
...
function from_candid_variant_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "plywood" in value ? Category.plywood : "kitchen" in value ? Category.kitchen : "electricals" in value ? Category.electricals : "hardware" in value ? Category.hardware : "wardrobe" in value ? Category.wardrobe : "paints" in value ? Category.paints : "laminates" in value ? Category.laminates : value;
}
...
function to_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Category): {
    ...
    return value == Category.plywood ? {
        plywood: null
    } : value == Category.kitchen ? {
        kitchen: null
    } : value == Category.electricals ? {
        electricals: null
    } : value == Category.hardware ? {
        hardware: null
    } : value == Category.wardrobe ? {
        wardrobe: null
    } : value == Category.paints ? {
        paints: null
    } : value == Category.laminates ? {
        laminates: null
    } : value;
}
